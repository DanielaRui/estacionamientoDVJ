...
export class HomePage {
  ...
  getEstacionamientos(){
    this.database.getEstacionamiento().subscribe((data) => {
  ...
  updateEstacionamientos(_id: String, favorito: Boolean){
    ...
    this.database.updateEstacionamieno({ favorito: estacionamientosCopy[index].favorito }, _id).subscribe(
      (data) => {
      },
      (error) => {
        console.log(error);
